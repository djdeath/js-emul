...
let emitValue=(function (location,variable,expr){return ["$v(",location["start"],",",location["stop"],",\"",variable,"\",",expr,")"].join("");});let emitValueBefore=(function (expr,opExpr,loc){return ["(function(){",opExpr,";var $r=",expr,";return ",emitValue(loc,expr,"$r"),";})()"].join("");});let BSJSTranslator=objectThatDelegatesTo(OMeta,{
...
"while":function(){var $elf=this,$vars={},$r0=this._startStructure(1781, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),1784);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1787);$r0.value=((("while(" + $vars.cond) + ")") + $vars.body);return this._endStructure($r0);},
"doWhile":function(){var $elf=this,$vars={},$r0=this._startStructure(1790, true);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1793);$vars.cond=this._appendStructure($r0,this._apply("trans"),1796);$r0.value=(((("do" + $vars.body) + "while(") + $vars.cond) + ")");return this._endStructure($r0);},
"for":function(){var $elf=this,$vars={},$r0=this._startStructure(1799, true);$vars.init=this._appendStructure($r0,this._apply("trans"),1802);$vars.cond=this._appendStructure($r0,this._apply("trans"),1805);$vars.upd=this._appendStructure($r0,this._apply("trans"),1808);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1811);$vars.l=this._getStructureValue(this.anything());$r0.value=((((((((("for(" + $vars.init) + ";") + $vars.cond) + ";") + emitEvent($vars.l,"for")) + ",") + $vars.upd) + ")") + $vars.body);return this._endStructure($r0);},
"forIn":function(){var $elf=this,$vars={},$r0=this._startStructure(1815, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1818);$vars.arr=this._appendStructure($r0,this._apply("trans"),1821);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1824);$r0.value=((((("for(" + $vars.x) + " in ") + $vars.arr) + ")") + $vars.body);return this._endStructure($r0);},
"beginTop":function(){var $elf=this,$vars={},$r0=this._startStructure(1827, true);$vars.xs=this._appendStructure($r0,this._many(function(){var $r1=this._startStructure(1832);$vars.x=this._appendStructure($r1,this._apply("trans"),1835);$r1.value=this._appendStructure($r1,this._or(function(){var $r2=this._startStructure(1839);this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1842);$r3.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r3);},function(){return this._forwardStructure(this.end(),1845);}),1841);$r2.value=$vars.x;return this._endStructure($r2);},function(){var $r2=this._startStructure(1848);this._appendStructure($r2,this._apply("empty"),1850);$r2.value=($vars.x + ";");return this._endStructure($r2);}),1837);return this._endStructure($r1);}),1830);$r0.value=$vars.xs.join("");return this._endStructure($r0);},
"begin":function(){var $elf=this,$vars={},$r0=this._startStructure(1854, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1857);$vars.x=this._appendStructure($r1,this._apply("trans"),1860);this._appendStructure($r1,this.end(),1862);$r1.value=$vars.x;return this._endStructure($r1);},function(){var $r1=this._startStructure(1865);$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1870);$vars.x=this._appendStructure($r2,this._apply("trans"),1873);$r2.value=this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1877);this._appendStructure($r3,this._or(function(){var $r4=this._startStructure(1880);$r4.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r4);},function(){return this._forwardStructure(this.end(),1883);}),1879);$r3.value=$vars.x;return this._endStructure($r3);},function(){var $r3=this._startStructure(1886);this._appendStructure($r3,this._apply("empty"),1888);$r3.value=($vars.x + ";");return this._endStructure($r3);}),1875);return this._endStructure($r2);}),1868);$r1.value=(("{" + $vars.xs.join("")) + "}");return this._endStructure($r1);}),1855);return this._endStructure($r0);},
"beginVars":function(){var $elf=this,$vars={},$r0=this._startStructure(1892, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1895);$vars.decl=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r1,this._apply("trans"),1899);this._appendStructure($r1,this.end(),1901);$r1.value=(($vars.decl + " ") + $vars.x);return this._endStructure($r1);},function(){var $r1=this._startStructure(1904);$vars.decl=this._getStructureValue(this.anything());$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1909);$r2.value=($vars.x=this._appendStructure($r2,this._apply("trans"),1912));return this._endStructure($r2);}),1908);$r1.value=(($vars.decl + " ") + $vars.xs.join(","));return this._endStructure($r1);}),1893);return this._endStructure($r0);},
"func":function(){var $elf=this,$vars={},$r0=this._startStructure(1915, true);$vars.args=this._getStructureValue(this.anything());$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1919);$r0.value=(((("(function (" + $vars.args.join(",")) + ")") + $vars.body) + ")");return this._endStructure($r0);},
"call":function(){var $elf=this,$vars={},$r0=this._startStructure(1922, true);$vars.fn=this._appendStructure($r0,this._apply("trans"),1925);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1930);}),1928);$vars.l=this._getStructureValue(this.anything());$r0.value=(($vars.fn == "log")?((($vars.fn + "(") + emitValue($vars.l,$vars.fn,$vars.args.join(","))) + ")"):((($vars.fn + "(") + $vars.args.join(",")) + ")"));return this._endStructure($r0);},
"send":function(){var $elf=this,$vars={},$r0=this._startStructure(1934, true);$vars.msg=this._getStructureValue(this.anything());$vars.recv=this._appendStructure($r0,this._apply("trans"),1938);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1943);}),1941);$r0.value=((((($vars.recv + ".") + $vars.msg) + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"new":function(){var $elf=this,$vars={},$r0=this._startStructure(1946, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1949);$r0.value=("new " + $vars.x);return this._endStructure($r0);},
"assignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1952, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1956);$vars.l=this._getStructureValue(this.anything());$r0.value=(($vars.name + "=") + emitValue($vars.l,$vars.name,$vars.val));return this._endStructure($r0);},
"noAssignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1960, true);$vars.name=this._getStructureValue(this.anything());$r0.value=$vars.name;return this._endStructure($r0);},
"throw":function(){var $elf=this,$vars={},$r0=this._startStructure(1964, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1967);$r0.value=("throw " + $vars.x);return this._endStructure($r0);},
"try":function(){var $elf=this,$vars={},$r0=this._startStructure(1970, true);$vars.x=this._appendStructure($r0,this._apply("curlyTrans"),1973);$vars.name=this._getStructureValue(this.anything());$vars.c=this._appendStructure($r0,this._apply("curlyTrans"),1977);$vars.f=this._appendStructure($r0,this._apply("curlyTrans"),1980);$r0.value=((((((("try " + $vars.x) + "catch(") + $vars.name) + ")") + $vars.c) + "finally") + $vars.f);return this._endStructure($r0);},
"json":function(){var $elf=this,$vars={},$r0=this._startStructure(1983, true);$vars.props=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1988);}),1986);$r0.value=(("({" + $vars.props.join(",")) + "})");return this._endStructure($r0);},
"binding":function(){var $elf=this,$vars={},$r0=this._startStructure(1991, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1995);$r0.value=(($vars.name.toProgramString() + ": ") + $vars.val);return this._endStructure($r0);},
"switch":function(){var $elf=this,$vars={},$r0=this._startStructure(1998, true);$vars.x=this._appendStructure($r0,this._apply("trans"),2001);$vars.cases=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),2006);}),2004);$r0.value=(((("switch(" + $vars.x) + "){") + $vars.cases.join(";")) + "}");return this._endStructure($r0);},
"case":function(){var $elf=this,$vars={},$r0=this._startStructure(2009, true);$vars.x=this._appendStructure($r0,this._apply("trans"),2012);$vars.y=this._appendStructure($r0,this._apply("trans"),2015);$r0.value=((("case " + $vars.x) + ": ") + $vars.y);return this._endStructure($r0);},
"default":function(){var $elf=this,$vars={},$r0=this._startStructure(2018, true);$vars.y=this._appendStructure($r0,this._apply("trans"),2021);$r0.value=("default: " + $vars.y);return this._endStructure($r0);},
"emitEvent":function(){var $elf=this,$vars={},$r0=this._startStructure(2024, true);$vars.name=this._getStructureValue(this.anything());$vars.l=this._getStructureValue(this.anything());$r0.value=(((((("$e(" + $vars.l["start"]) + ",") + $vars.l["stop"]) + ",\"") + $vars.name) + "\")");return this._endStructure($r0);}})
