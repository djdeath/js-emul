...
"return":function(){var $elf=this,$vars={},$r0=this._startStructure(1722, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1725);$vars.p=this._getStructureValue(this.anything());$r0.value=("return " + emitValue($vars.p,"return",$vars.x));return this._endStructure($r0);},
"with":function(){var $elf=this,$vars={},$r0=this._startStructure(1729, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1732);$vars.s=this._appendStructure($r0,this._apply("curlyTrans"),1735);$r0.value=((("with(" + $vars.x) + ")") + $vars.s);return this._endStructure($r0);},
"if":function(){var $elf=this,$vars={},$r0=this._startStructure(1738, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),1741);$vars.t=this._appendStructure($r0,this._apply("curlyTrans"),1744);$vars.e=this._appendStructure($r0,this._apply("curlyTrans"),1747);$r0.value=((((("if(" + $vars.cond) + ")") + $vars.t) + "else") + $vars.e);return this._endStructure($r0);},
"condExpr":function(){var $elf=this,$vars={},$r0=this._startStructure(1750, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),1753);$vars.t=this._appendStructure($r0,this._apply("trans"),1756);$vars.e=this._appendStructure($r0,this._apply("trans"),1759);$r0.value=(((((("(" + $vars.cond) + "?") + $vars.t) + ":") + $vars.e) + ")");return this._endStructure($r0);},
"while":function(){var $elf=this,$vars={},$r0=this._startStructure(1762, true);$vars.cond=this._appendStructure($r0,this._apply("trans"),1765);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1768);$r0.value=((("while(" + $vars.cond) + ")") + $vars.body);return this._endStructure($r0);},
"doWhile":function(){var $elf=this,$vars={},$r0=this._startStructure(1771, true);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1774);$vars.cond=this._appendStructure($r0,this._apply("trans"),1777);$r0.value=(((("do" + $vars.body) + "while(") + $vars.cond) + ")");return this._endStructure($r0);},
"for":function(){var $elf=this,$vars={},$r0=this._startStructure(1780, true);$vars.init=this._appendStructure($r0,this._apply("trans"),1783);$vars.cond=this._appendStructure($r0,this._apply("trans"),1786);$vars.upd=this._appendStructure($r0,this._apply("trans"),1789);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1792);$r0.value=((((((("for(" + $vars.init) + ";") + $vars.cond) + ";") + $vars.upd) + ")") + $vars.body);return this._endStructure($r0);},
"forIn":function(){var $elf=this,$vars={},$r0=this._startStructure(1795, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1798);$vars.arr=this._appendStructure($r0,this._apply("trans"),1801);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1804);$r0.value=((((("for(" + $vars.x) + " in ") + $vars.arr) + ")") + $vars.body);return this._endStructure($r0);},
"beginTop":function(){var $elf=this,$vars={},$r0=this._startStructure(1807, true);$vars.xs=this._appendStructure($r0,this._many(function(){var $r1=this._startStructure(1812);$vars.x=this._appendStructure($r1,this._apply("trans"),1815);$r1.value=this._appendStructure($r1,this._or(function(){var $r2=this._startStructure(1819);this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1822);$r3.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r3);},function(){return this._forwardStructure(this.end(),1825);}),1821);$r2.value=$vars.x;return this._endStructure($r2);},function(){var $r2=this._startStructure(1828);this._appendStructure($r2,this._apply("empty"),1830);$r2.value=($vars.x + ";");return this._endStructure($r2);}),1817);return this._endStructure($r1);}),1810);$r0.value=$vars.xs.join("");return this._endStructure($r0);},
"begin":function(){var $elf=this,$vars={},$r0=this._startStructure(1834, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1837);$vars.x=this._appendStructure($r1,this._apply("trans"),1840);this._appendStructure($r1,this.end(),1842);$r1.value=$vars.x;return this._endStructure($r1);},function(){var $r1=this._startStructure(1845);$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1850);$vars.x=this._appendStructure($r2,this._apply("trans"),1853);$r2.value=this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1857);this._appendStructure($r3,this._or(function(){var $r4=this._startStructure(1860);$r4.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r4);},function(){return this._forwardStructure(this.end(),1863);}),1859);$r3.value=$vars.x;return this._endStructure($r3);},function(){var $r3=this._startStructure(1866);this._appendStructure($r3,this._apply("empty"),1868);$r3.value=($vars.x + ";");return this._endStructure($r3);}),1855);return this._endStructure($r2);}),1848);$r1.value=(("{" + $vars.xs.join("")) + "}");return this._endStructure($r1);}),1835);return this._endStructure($r0);},
"beginVars":function(){var $elf=this,$vars={},$r0=this._startStructure(1872, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1875);$vars.decl=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r1,this._apply("trans"),1879);this._appendStructure($r1,this.end(),1881);$r1.value=(($vars.decl + " ") + $vars.x);return this._endStructure($r1);},function(){var $r1=this._startStructure(1884);$vars.decl=this._getStructureValue(this.anything());$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1889);$r2.value=($vars.x=this._appendStructure($r2,this._apply("trans"),1892));return this._endStructure($r2);}),1888);$r1.value=(($vars.decl + " ") + $vars.xs.join(","));return this._endStructure($r1);}),1873);return this._endStructure($r0);},
"func":function(){var $elf=this,$vars={},$r0=this._startStructure(1895, true);$vars.args=this._getStructureValue(this.anything());$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1899);$r0.value=(((("(function (" + $vars.args.join(",")) + ")") + $vars.body) + ")");return this._endStructure($r0);},
"call":function(){var $elf=this,$vars={},$r0=this._startStructure(1902, true);$vars.fn=this._appendStructure($r0,this._apply("trans"),1905);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1910);}),1908);$r0.value=((($vars.fn + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"send":function(){var $elf=this,$vars={},$r0=this._startStructure(1913, true);$vars.msg=this._getStructureValue(this.anything());$vars.recv=this._appendStructure($r0,this._apply("trans"),1917);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1922);}),1920);$r0.value=((((($vars.recv + ".") + $vars.msg) + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"new":function(){var $elf=this,$vars={},$r0=this._startStructure(1925, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1928);$r0.value=("new " + $vars.x);return this._endStructure($r0);},
"assignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1931, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1935);$vars.p=this._getStructureValue(this.anything());$r0.value=(($vars.name + "=") + emitValue($vars.p,$vars.name,$vars.val));return this._endStructure($r0);},
"noAssignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1939, true);$vars.name=this._getStructureValue(this.anything());$r0.value=$vars.name;return this._endStructure($r0);},
"throw":function(){var $elf=this,$vars={},$r0=this._startStructure(1943, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1946);$r0.value=("throw " + $vars.x);return this._endStructure($r0);},
"try":function(){var $elf=this,$vars={},$r0=this._startStructure(1949, true);$vars.x=this._appendStructure($r0,this._apply("curlyTrans"),1952);$vars.name=this._getStructureValue(this.anything());$vars.c=this._appendStructure($r0,this._apply("curlyTrans"),1956);$vars.f=this._appendStructure($r0,this._apply("curlyTrans"),1959);$r0.value=((((((("try " + $vars.x) + "catch(") + $vars.name) + ")") + $vars.c) + "finally") + $vars.f);return this._endStructure($r0);},
"json":function(){var $elf=this,$vars={},$r0=this._startStructure(1962, true);$vars.props=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1967);}),1965);$r0.value=(("({" + $vars.props.join(",")) + "})");return this._endStructure($r0);},
"binding":function(){var $elf=this,$vars={},$r0=this._startStructure(1970, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1974);$r0.value=(($vars.name.toProgramString() + ": ") + $vars.val);return this._endStructure($r0);},
"switch":function(){var $elf=this,$vars={},$r0=this._startStructure(1977, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1980);$vars.cases=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1985);}),1983);$r0.value=(((("switch(" + $vars.x) + "){") + $vars.cases.join(";")) + "}");return this._endStructure($r0);},
"case":function(){var $elf=this,$vars={},$r0=this._startStructure(1988, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1991);$vars.y=this._appendStructure($r0,this._apply("trans"),1994);$r0.value=((("case " + $vars.x) + ": ") + $vars.y);return this._endStructure($r0);},
"default":function(){var $elf=this,$vars={},$r0=this._startStructure(1997, true);$vars.y=this._appendStructure($r0,this._apply("trans"),2000);$r0.value=("default: " + $vars.y);return this._endStructure($r0);}})
