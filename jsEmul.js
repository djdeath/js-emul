...
"for":function(){var $elf=this,$vars={},$r0=this._startStructure(1799, true);$vars.init=this._appendStructure($r0,this._apply("trans"),1802);$vars.cond=this._appendStructure($r0,this._apply("trans"),1805);$vars.upd=this._appendStructure($r0,this._apply("trans"),1808);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1811);$r0.value=((((((("for(" + $vars.init) + ";") + $vars.cond) + ";") + $vars.upd) + ")") + $vars.body);return this._endStructure($r0);},
"forIn":function(){var $elf=this,$vars={},$r0=this._startStructure(1814, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1817);$vars.arr=this._appendStructure($r0,this._apply("trans"),1820);$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1823);$r0.value=((((("for(" + $vars.x) + " in ") + $vars.arr) + ")") + $vars.body);return this._endStructure($r0);},
"beginTop":function(){var $elf=this,$vars={},$r0=this._startStructure(1826, true);$vars.xs=this._appendStructure($r0,this._many(function(){var $r1=this._startStructure(1831);$vars.x=this._appendStructure($r1,this._apply("trans"),1834);$r1.value=this._appendStructure($r1,this._or(function(){var $r2=this._startStructure(1838);this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1841);$r3.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r3);},function(){return this._forwardStructure(this.end(),1844);}),1840);$r2.value=$vars.x;return this._endStructure($r2);},function(){var $r2=this._startStructure(1847);this._appendStructure($r2,this._apply("empty"),1849);$r2.value=($vars.x + ";");return this._endStructure($r2);}),1836);return this._endStructure($r1);}),1829);$r0.value=$vars.xs.join("");return this._endStructure($r0);},
"begin":function(){var $elf=this,$vars={},$r0=this._startStructure(1853, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1856);$vars.x=this._appendStructure($r1,this._apply("trans"),1859);this._appendStructure($r1,this.end(),1861);$r1.value=$vars.x;return this._endStructure($r1);},function(){var $r1=this._startStructure(1864);$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1869);$vars.x=this._appendStructure($r2,this._apply("trans"),1872);$r2.value=this._appendStructure($r2,this._or(function(){var $r3=this._startStructure(1876);this._appendStructure($r3,this._or(function(){var $r4=this._startStructure(1879);$r4.value=this._pred(($vars.x[($vars.x["length"] - (1))] == "}"));return this._endStructure($r4);},function(){return this._forwardStructure(this.end(),1882);}),1878);$r3.value=$vars.x;return this._endStructure($r3);},function(){var $r3=this._startStructure(1885);this._appendStructure($r3,this._apply("empty"),1887);$r3.value=($vars.x + ";");return this._endStructure($r3);}),1874);return this._endStructure($r2);}),1867);$r1.value=(("{" + $vars.xs.join("")) + "}");return this._endStructure($r1);}),1854);return this._endStructure($r0);},
"beginVars":function(){var $elf=this,$vars={},$r0=this._startStructure(1891, true);$r0.value=this._appendStructure($r0,this._or(function(){var $r1=this._startStructure(1894);$vars.decl=this._getStructureValue(this.anything());$vars.x=this._appendStructure($r1,this._apply("trans"),1898);this._appendStructure($r1,this.end(),1900);$r1.value=(($vars.decl + " ") + $vars.x);return this._endStructure($r1);},function(){var $r1=this._startStructure(1903);$vars.decl=this._getStructureValue(this.anything());$vars.xs=this._appendStructure($r1,this._many(function(){var $r2=this._startStructure(1908);$r2.value=($vars.x=this._appendStructure($r2,this._apply("trans"),1911));return this._endStructure($r2);}),1907);$r1.value=(($vars.decl + " ") + $vars.xs.join(","));return this._endStructure($r1);}),1892);return this._endStructure($r0);},
"func":function(){var $elf=this,$vars={},$r0=this._startStructure(1914, true);$vars.args=this._getStructureValue(this.anything());$vars.body=this._appendStructure($r0,this._apply("curlyTrans"),1918);$r0.value=(((("(function (" + $vars.args.join(",")) + ")") + $vars.body) + ")");return this._endStructure($r0);},
"call":function(){var $elf=this,$vars={},$r0=this._startStructure(1921, true);$vars.fn=this._appendStructure($r0,this._apply("trans"),1924);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1929);}),1927);$vars.l=this._getStructureValue(this.anything());$r0.value=(($vars.fn == "log")?((($vars.fn + "(") + emitValue($vars.l,$vars.fn,$vars.args.join(","))) + ")"):((($vars.fn + "(") + $vars.args.join(",")) + ")"));return this._endStructure($r0);},
"send":function(){var $elf=this,$vars={},$r0=this._startStructure(1933, true);$vars.msg=this._getStructureValue(this.anything());$vars.recv=this._appendStructure($r0,this._apply("trans"),1937);$vars.args=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1942);}),1940);$r0.value=((((($vars.recv + ".") + $vars.msg) + "(") + $vars.args.join(",")) + ")");return this._endStructure($r0);},
"new":function(){var $elf=this,$vars={},$r0=this._startStructure(1945, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1948);$r0.value=("new " + $vars.x);return this._endStructure($r0);},
"assignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1951, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1955);$vars.l=this._getStructureValue(this.anything());$r0.value=(($vars.name + "=") + emitValue($vars.l,$vars.name,$vars.val));return this._endStructure($r0);},
"noAssignVar":function(){var $elf=this,$vars={},$r0=this._startStructure(1959, true);$vars.name=this._getStructureValue(this.anything());$r0.value=$vars.name;return this._endStructure($r0);},
"throw":function(){var $elf=this,$vars={},$r0=this._startStructure(1963, true);$vars.x=this._appendStructure($r0,this._apply("trans"),1966);$r0.value=("throw " + $vars.x);return this._endStructure($r0);},
"try":function(){var $elf=this,$vars={},$r0=this._startStructure(1969, true);$vars.x=this._appendStructure($r0,this._apply("curlyTrans"),1972);$vars.name=this._getStructureValue(this.anything());$vars.c=this._appendStructure($r0,this._apply("curlyTrans"),1976);$vars.f=this._appendStructure($r0,this._apply("curlyTrans"),1979);$r0.value=((((((("try " + $vars.x) + "catch(") + $vars.name) + ")") + $vars.c) + "finally") + $vars.f);return this._endStructure($r0);},
"json":function(){var $elf=this,$vars={},$r0=this._startStructure(1982, true);$vars.props=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),1987);}),1985);$r0.value=(("({" + $vars.props.join(",")) + "})");return this._endStructure($r0);},
"binding":function(){var $elf=this,$vars={},$r0=this._startStructure(1990, true);$vars.name=this._getStructureValue(this.anything());$vars.val=this._appendStructure($r0,this._apply("trans"),1994);$r0.value=(($vars.name.toProgramString() + ": ") + $vars.val);return this._endStructure($r0);},
"switch":function(){var $elf=this,$vars={},$r0=this._startStructure(1997, true);$vars.x=this._appendStructure($r0,this._apply("trans"),2000);$vars.cases=this._appendStructure($r0,this._many(function(){return this._forwardStructure(this._apply("trans"),2005);}),2003);$r0.value=(((("switch(" + $vars.x) + "){") + $vars.cases.join(";")) + "}");return this._endStructure($r0);},
"case":function(){var $elf=this,$vars={},$r0=this._startStructure(2008, true);$vars.x=this._appendStructure($r0,this._apply("trans"),2011);$vars.y=this._appendStructure($r0,this._apply("trans"),2014);$r0.value=((("case " + $vars.x) + ": ") + $vars.y);return this._endStructure($r0);},
"default":function(){var $elf=this,$vars={},$r0=this._startStructure(2017, true);$vars.y=this._appendStructure($r0,this._apply("trans"),2020);$r0.value=("default: " + $vars.y);return this._endStructure($r0);},
"emitEvent":function(){var $elf=this,$vars={},$r0=this._startStructure(2023, true);$vars.name=this._getStructureValue(this.anything());$vars.l=this._getStructureValue(this.anything());$r0.value=(((((("$e(" + $vars.l["start"]) + ",") + $vars.l["stop"]) + ",\"") + $vars.name) + "\")");return this._endStructure($r0);}})
